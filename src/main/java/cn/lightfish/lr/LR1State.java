...
public class LR1State {
    ...
    public static LR1State build(Context yaccFile, List<LR1Item> items) {
        LR1State newState = new LR1State(items);
        newState.closure(yaccFile);
        return newState;
    }

    public static LR1State build(Context yaccFile, LR1Item item) {
    ...
    public LR1State shift(Symbol shiftSymbol, Context yaccFile) {
     ...
     * @param yaccFile
     */
    public void closure(Context yaccFile) {
